...
-- Network widget https://github.com/pltanton/net_widgets
...
awful.screen.connect_for_each_screen(function(s)
	...
	local my_task_shape = function(cr, width, height)
	...
	s.mytasklist = awful.widget.tasklist({
		...
		style = {
			...
			shape_border_color_focus = beautiful.tasklist_fg_focus,
			shape = my_task_shape,
		},
		layout = {
			spacing = 5,
...
globalkeys = gears.table.join(
	...
	awful.key({ modkey }, "p", function()
		awful.spawn("rofi -show drun -theme gruvbox-dark")
...
awful.spawn.with_shell(
	"xrandr --output DisplayPort-0 --primary --mode 1920x1080 --pos 0x0 --rotate normal --output DisplayPort-2 --off --output DisplayPort-1 --mode 2560x1440 --pos 3840x0 --rotate normal --output HDMI-A-0 --mode 1920x1080 --pos 1920x0 --rotate normal"
)
